...
export class JwtAuthGuard implements CanActivate {
  ...
  private getSignedCookie(
    ...
    if (!signedCookies || !signedCookies[key]) return null;

    const [accessToken, id]: string[] = signedCookies[key].split(' ');
